...
const tornadoAddress = "0x4C603B194e9Ad83028307FE05f8F41b93D6687df";
...
const Interface = () => {
  ...
  const withdraw = async () => {
    ...
    try {
      ...
      console.log(SnarkJS, "SNARK JS MAIN OBJECT");

      const proofInput = {
        root: $u.BNToDecimal(decodedData.root),
        nullifierHash: proofElements.nullifierHash,
        recipient: $u.BNToDecimal(account.address), //  we need to change the recipient to decimal so it can be used in the mulitplication in the circuit .. the last part of the withdraw circuit has some constraint
      ...
      const callInputs = [
        ...
        // in writing the withdraw circom we made the recipient public but we dont to pass that to the smart contract otherwise the miner can take advantage
        ...
        <div className="card mx-auto" style={{ maxWidth: 450 }}>
                    ...
                    <div className="alert alert-success p-3">
                      ...
                      <div style={{ marginTop: 5 }}>
                        <span className="text-secondary">
                          Withdrawal successful. You can check your wallet to
                          verify your funds.
                        </span>
                      </div>
                    </div>
          ...
          <div className="card-footer p-4" style={{ lineHeight: "15px" }}>
            <span className="small text-secondary" style={{ fontSize: "12px" }}>
              <strong>Disclaimer:</strong> Products intended for educational
              purposes are <i>not</i> to be used with commercial intent. NFTA,
              the organization who sponsored the development of this project,
              explicitly prohibits and assumes no responsibilities for losses
              due to such use.
            </span>
          </div>
        </div>
